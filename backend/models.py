...
class GesturePrediction(BaseModel):
    ...
    def validate_and_normalize(cls, data: Any) -> Any:
        ...
        # Neither valid hands nor valid gesture+confidence was provided
        raise ValueError(
            "Payload must contain either a non-empty 'hands' list or 'gesture' and 'confidence'."
        )
